                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <span class="display-5"><i class="icon-note gradient-2-text"></i></span>
                                    <h2 class="mt-3">Nomor Surat</h2>
                                    <p></p>
                ...
                <div class="row">
                        <div class="col">
                            <div class="card card-widget">
                                <div class="card-body">
                                    <h5 class="text-muted">Disposisi Overview</h5>
                        ...
                        <div class="col">
                            <div class="card card-widget">
                                <div class="card-body">
                                    <h5 class="text-muted">Surat Overview</h5>
                                    <h2 class="mt-4">5680</h2>
                                    <span>Total Revenue</span>
                                    <div class="mt-4">
                                        <h4>30</h4>
